...
export default function GemstoneReviews() {
  return (
    <section className="w-full bg-[#FDFCF8] py-16 lg:py-28 overflow-hidden font-sans border-t border-[#E8C46F]/20">
      {/* --- HEADER --- */}
      <div className="container mx-auto px-6 mb-12 lg:mb-16 text-center">
        <span className="text-[#E8C46F] text-[10px] font-bold tracking-[0.25em] uppercase mb-4 block">
          Client Stories
        </span>
      ...
      <div className="relative w-full">
        {/* Gradient Masks (Hidden on mobile to avoid covering content) */}
        ...
        {/* MOBILE: overflow-x-auto, no-scrollbar, snap-x (for swipe)
                   DESKTOP: animate-infinite-scroll 
                */}
        <div
          className="
                ...
                "
        >
          {/* We map reviews once for mobile, duplicate for desktop loop */}
          {/* Check screen size in CSS or just render enough items. Here we duplicate for safety but mobile scroll handles it. */}
              ...
              <div className="flex items-center gap-4 pt-4 lg:pt-6 border-t border-gray-50">
                <div className="relative w-10 h-10 lg:w-12 lg:h-12 rounded-full overflow-hidden border border-gray-100 group-hover:border-[#E8C46F] transition-colors flex-shrink-0">
                  <img
                    ...
                    onError={(e) => (e.target.src = "/placeholder-avatar.png")} // Fallback
                  />
                </div>
      ...
      {/* Custom Animation & Mobile Scroll Hide */}
      <style>{`
